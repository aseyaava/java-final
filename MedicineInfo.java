 ...
 * @author pc
 */
public class MedicineInfo extends JFrame implements ActionListener{
    ...
    MedicineInfo (String bx, String ex,String use){
        this.use=use;
        
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setSize(900,700);
        setLocationRelativeTo(null);
        setTitle("Available Medicine");
        setResizable(false);
        ...
        f3=new Font("Arial",Font.BOLD,20);
         ...
         c.setBackground(new Color(0,0,0));
           ...
           c.add(label2);
            ...
            label3 = new JLabel("Available Medicine");
           //label1.setText("Welcome To");
           label3.setBounds(150,30,900,100);
           label3.setForeground(Color.RED);
           label3.setFont(f2);
           c.add(label3);
           // JOptionPane.showMessageDialog(this,"Give Suitable Quantity");
